...
const WhatsAppButton = () => {
  ...
  const [admin1, setAdmin1] = useState<string>('6281235907956');
  const [admin2, setAdmin2] = useState<string | null>('6281332345448');
  ...
  useEffect(() => {
    const fetchPhoneFromSanity = async () => {
      try {
        ...
        const rawPhone = data?.result?.phone || STORE_CONFIG.phone || '6281235907956, 6281332345448';
